...
const ProfilePage = () => {
  ...
  return (
    <div className=' bg-white md:mt-16 max-w-7xl mx-auto'>
      ...
      <div className=' bg-white px-3  flex flex-col lg:flex-row justify-center items-center lg:gap-8 gap-4 md:mx-4 '>
        {/* Left Profile Card */}
        <div className='px-6 py-4 bg-white rounded-lg border border-[#dbdbdb] flex flex-col justify-center items-center space-y-6'>
          <div className=''>
            <div className='w-auto h-[220px] px-4 '>
              {' '}
              <img
                src={user?.image}
                alt='mobileLogo'
