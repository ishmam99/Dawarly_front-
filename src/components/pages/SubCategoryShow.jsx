      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 lg:gap-8 gap-3 mt-8 lg:mx-0 md:mx-4 px-4 font-['Poppins'] mb-24">
        {technicians.map((technician, index) =>
          technician.status !== 'pending' ? (
            ...
            >
              <Link
                to={`/technicians/${technician.id}?subcategoryName=${subCategory?.name}&categoryName=${categoryName}`}
              >
                <div className='lg:w-[211px] lg:h-[211px] md:w-[180px] md:h-[180px] w-[160px] h-[160px] md:mt-6 bg-[#d9d9d9] rounded-full'>
                  <img
              ...
              {/* <div className='flex gap-2 mt-4'>
                <div className='p-1 bg-white shadow-sm hover:bg-green-600 rounded-full flex justify-center items-center'>
                  <img
                    ...
                    className='w-7 h-7 '
                    onClick={() =>
                      window.open(`https://wa.me/${technician?.phone}`)
                    }
                ...
                <div className='w-9 h-9 bg-white shadow-sm hover:bg-blue-500 rounded-full flex justify-center items-center'>
                  <img
                    ...
                    alt='call'
                    className='w-4 h-4'
                    onClick={() => window.open(`tel:00${technician?.phone}`)}
                    style={{ cursor: 'pointer' }}
                  />
                </div>
              </div> */}
              <div className='flex gap-3 mb-2'>
                <div className='p-1 bg-gray-100 shadow-md rounded-full flex justify-center items-center'>
                  <svg
                ...
                <div
                  onClick={() => window.open(`tel:00${technician?.phone}`)}
                  className='w-9 h-9 bg-gray-100 shadow-md rounded-full flex justify-center items-center'
                >
              ...
              <h3 className='mt-4 text-black text-right text-base font-medium '>
                {technician.name}
              </h3>
            </div>
          ) : null
