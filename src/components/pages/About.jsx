...
const About = () => {
  ...
  return (
    <div className='max-w-7xl min-h-[70vh] mx-auto'>
      ...
      <div className='grid lg:grid-cols-2 my-4 space-y-6'>
        {/* Left Side - Image */}
        ...
        <div className='flex px-5 flex-col justify-center mt-6 md:mt-0 md:pl-12 text-center md:text-left'>
          ...
          <p className="text-gray-600 text-end text-base leading-relaxed font-['Poppins']">
            ...
            والاستفسار يرجى مراسلتنا على الواتساب 0096555320323  
          </p>
        </div>
        <div className='flex h-full py-10 justify-center items-center gap-3 mb-2'>
          <div className='p-1 bg-white shadow-sm rounded-full flex justify-center items-center'>
            <svg
              ...
              onClick={() => window.open(`https://wa.me/0096555320323`)}
